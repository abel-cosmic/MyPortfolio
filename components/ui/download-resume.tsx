...
export const DownloadCV = ({
    ...
    return (
        <div
            className="flex items-center gap-1 pr-6 h-11 rounded-full border border-border bg-card hover:bg-accent/50 hover:border-primary/50 transition-all duration-300 shadow-sm w-full sm:w-auto justify-center sm:justify-start cursor-pointer"
        ...
        >
            <div className="w-[50px] h-full flex items-center justify-center relative">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pt-[6px] pr-1">
                    <Folder
                        size={0.4}
                        color="var(--primary)"
