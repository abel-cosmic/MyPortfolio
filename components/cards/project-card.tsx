...
export const ProjectCard = ({
  ...
  return (
    ...
    >
      {/* Preview — only the screenshot is “contained”; no outer card */}
      <div className="w-full shrink-0 md:w-[46%] md:max-w-md">
        {liveUrl ? (
          <Link
            ...
            className="block cursor-target outline-none ring-offset-background focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-xl overflow-hidden"
