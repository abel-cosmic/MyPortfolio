          ...
          <div>
            ...
            <div className="space-y-8">
              {educationDetails.map((edu, idx) => (
                <div
                  key={idx}
                  className="rounded-2xl border border-border bg-card p-6 shadow-sm hover:border-primary/30 hover:shadow-md transition-all duration-300"
                >
                  <h3
                  ...
                  {edu.detail && (
                    <p className="text-sm text-muted-foreground bg-secondary/50 inline-flex px-2 py-1 rounded-md">
                      {edu.detail}
                    </p>
                  )}
                </div>
